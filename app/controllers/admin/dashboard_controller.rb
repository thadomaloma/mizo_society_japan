  ...
  class DashboardController < ApplicationController
    def index
      ...
      @welfare_summary = {
        ...
        resolved: resolved_welfare_count
      }
    ...
    def finance_chart
      Rails.cache.fetch("admin_dashboard/finance_chart/#{Date.current.year}-#{Date.current.month}", expires_in: 10.minutes) do
    ...
    def membership_payment_summary
      Rails.cache.fetch("admin_dashboard/membership_payment_summary/#{Date.current}", expires_in: 2.minutes) do
